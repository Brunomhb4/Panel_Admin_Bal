...
import { FileText, Users, Coffee, Calendar, TrendingUp, Clock } from 'lucide-react';
import { useDashboardStore } from '../../stores/dashboardStore';

const DashboardStats: React.FC = () => {
  const { stats, selectedPeriod } = useDashboardStore();
  ...
  const statsCards = [
    ...
    },
    {
      ...
      value: Math.round((selectedPeriod === 'day' ? stats.dailyPeopleServed / stats.dailyTablesServed : stats.weeklyPeopleServed / stats.weeklyTablesServed) * 10) / 10,
      icon: TrendingUp,
